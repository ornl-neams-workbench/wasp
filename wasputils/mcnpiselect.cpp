...
int main(int argc, char* argv[])
{
    ...
    if (argc < 2)
    {
        std::cout << "Workbench Analysis Sequence Processor (MCNP)" << std::endl
                  << argv[0]
                  << " : An application for selecting MCNP formatted input."
                  << std::endl;
        std::cout << " Usage : " << argv[0]
                  << " path/to/MCNP/formatted/input 'siren select statement'..."
                  << std::endl
